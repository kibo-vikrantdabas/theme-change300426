    ...
    var modalDialog = Dialog.extend({
        ...
        autoAddProduct: function() {
            ...
            process.push(function () {
                return bogaProduct.fetch().then(function(product) {
                    console.log("BOGO product fetched:", product.get("productCode"));
            
                    // Fetch the latest cart data and render it
                    return product.collection.parent.fetch().then(function(cart) {
                        cart.trigger('render');
                        console.log("Cart refreshed with BOGO product.");
                        return product;
                    });
                }).catch(function(error) {
                    console.error("Error fetching BOGO product:", error);
                });
            });
            process.push(function () {          
