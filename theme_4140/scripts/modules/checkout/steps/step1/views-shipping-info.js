define(["modules/jquery-mozu", 
    ...
    function ($, _, Hypr, Backbone, HyprLiveContext, CheckoutStepView, EditableView, ShippingDestinationModels) {
        ...
        var ShippingDestinationContactView = Backbone.MozuView.extend({
            ...
            additionalEvents: {
                "change [data-mz-value='address.address4']": "updateAddress.address4",
                "input [data-mz-value='address.address4']": "updateAddress.address4",
                "keyup [data-mz-value='address.address4']": "updateAddress.address4"
            },
            renderOnChange: [
               'address.countryCode'
            ]
