    ...
    var ShippingStep = CheckoutStep.extend({
        ...
        validateAddresses : function(){
            ...
            var saveAddress = function(){
                ...
                // keep fulfillmentInfo contact address4 in sync for single-ship flows
                var destContact = shippingDestination.get('destinationContact');
                if (destContact && destContact.get('address') && self.getCheckout().get('fulfillmentInfo')) {
                    var fulfillmentContact = self.getCheckout().get('fulfillmentInfo').get('fulfillmentContact');
                    if (fulfillmentContact && fulfillmentContact.get('address')) {
                        fulfillmentContact.get('address').set('address4', destContact.get('address').get('address4'));
                    }
                }
