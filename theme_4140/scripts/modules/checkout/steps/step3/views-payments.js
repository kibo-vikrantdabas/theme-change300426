    ...
    function ($, _, Hypr, Backbone, HyprLiveContext, preserveElements, CheckoutStepView,PayPal, ApplePay) {
        ...
        var BillingInfoView = CheckoutStepView.extend({
            ...
            autoUpdate: [
                ...
                'billingContact.address.address4',
            ...
            additionalEvents: {
                ...
                "change [data-mz-value='billingContact.address.address4']": "updateBillingContact.address.address4",
                "input [data-mz-value='billingContact.address.address4']": "updateBillingContact.address.address4",
                "keyup [data-mz-value='billingContact.address.address4']": "updateBillingContact.address.address4"
            },
            initialize: function () {
